...
final class Installer
{
    ...
    private static function do_install(string $dsn): void
    {
        try {
            self::create_dirs();
    ...
    private static function ask_questions(): void
    {
        $warnings = [];
        $errors = [];
    ...
    // public just for unit test bootstrapping
    public static function create_dirs(): void
    {
    ...
    // public just for unit test bootstrapping
    public static function create_tables(Database $db): void
    {
        try {
    ...
    private static function write_config(string $dsn): void
    {
